...
import { getParameters, initParticles, computeAcceleration, leapfrogStart, leapfrogStep, getTextureData } from './sph/index';
...
export class MainGame extends App {
    ...
    setup() {
        ...
        this.shaderInfo = generateMetaballsShader(particlesCount);
        ...
        this.textureData = new Float32Array(particlesCount * 4);
